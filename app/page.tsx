...
export default function Home() {
  return (
      <div
          ...
          <h1 className="py-3.5 px-0.5 z-10 text-4xl text-amber-400 duration-1000 bg-white cursor-default text-edge-outline animate-title font-display sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text hover:rotate-12">
              Cosmos
          </h1>
